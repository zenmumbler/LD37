...
class Sound {
	...
	play(what: SFX) {
		...
		switch (what) {
			...
			case SFX.ToneA: buffer = assets.ping; source = this.toneSources[0]; gain = this.toneGain; volume = 1; rate = .5; break;
			case SFX.ToneB: buffer = assets.ping; source = this.toneSources[1]; gain = this.toneGain; volume = 1; rate = 1; break;
			case SFX.ToneC: buffer = assets.ping; source = this.toneSources[2]; gain = this.toneGain; volume = 1; rate = 1.5; break;
			case SFX.ToneD: buffer = assets.ping; source = this.toneSources[3]; gain = this.toneGain; volume = 1; rate = 2; break;
